...
class TestNewtonRaphson(Tests):
    ...
    def test_newton_raphson_iteration(self):
        ...
        energy_test, k_test, dyr_test, g_test, gr_test = newton_raphson_iteration(dofs_test, geo_test, geo_0_test, geo_n_test, k_test, set_test, auxgr_test, dofs_test.Free, dy_test, g_test, gr0_test, ig, num_step_test, t_test)
