            ...
            if os.path.exists(os.path.join(file_name_v_model)):
                ...
                trial = optuna.trial.create_trial(
                    ...
                    distributions={
                        ...
                        'kSubstrate': optuna.distributions.UniformDistribution(0.01, 100),
                        'cLineTension': optuna.distributions.UniformDistribution(1e-6, 1e-2),
                        'cLineTension_external': optuna.distributions.UniformDistribution(1e-6, 1e-2),
