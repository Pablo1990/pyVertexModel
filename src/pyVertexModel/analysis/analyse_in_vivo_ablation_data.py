...
input_folder = '/media/pablo/d7c61090-024c-469a-930c-f5ada47fb049/PabloVicenteMunuera/VertexModel/pyVertexModel/data/RnG4EcadGFP_UASROKRNAi_050317'
...
for txt_file in txt_files:
    ...
    time_end = 10
    edge_length_final = edge_length_final[time_steps_normalized <= 10]
    time_steps_normalized = time_steps_normalized[time_steps_normalized <= 10]
